 ...
 * Author: bugnofree
 * Since: 2018-10-02
 * Email: pwnkeeper@gmail.com
 * Warning: This file has been tested on Linux, MacOS but not Windows.
 *
 * This is a header-only file for C and C++ with some useful tools.
 * The latest version may be found here: https://github.com/ikey4u/ccutils
 *
 */
